...
void main() {
  group('ManualPlanEditorPage Widget Tests', () {
    ...
    testWidgets('ManualPlanEditorPage renders form and default routines', (tester) async {
    ...
    testWidgets('GymPage displays all routines of active plan and Plan erstellen button',
        (tester) async {
    ...
    testWidgets('WorkoutRunnerPage allows canceling started workout without saving', (tester) async {
