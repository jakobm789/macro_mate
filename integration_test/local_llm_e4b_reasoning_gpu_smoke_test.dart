...
void main() {
  ...
  testWidgets('Gemma 4 E4B Reasoning loads and answers on GPU', (tester) async {
    if (kIsWeb || !Platform.isAndroid) {
      debugPrint('[E4BReasoningGpuSmoke] Skipping: Android device required.');
      return;
    }

    final logs = ValueNotifier<List<String>>([]);
    final activeStep =
        ValueNotifier<String>('Initialisiere E4B Reasoning GPU-Test...');

    void log(String message, {String? step}) {
      debugPrint('[E4BReasoningGpuSmoke] $message');
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(title: const Text('Gemma E4B Reasoning GPU Smoke')),
          body: Padding(
    ...
    activeStep.value = 'E4B Reasoning GPU-Test bestanden';
